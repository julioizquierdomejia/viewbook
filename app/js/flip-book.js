! function(modules) {
    ...
    _libs.PDFJS.workerSrc = (window.PDFJS_LOCALE ? PDFJS_LOCALE : {
        pdfJsWorker: "app/js/pdf.worker.js",
        pdfJsCMapUrl: "cmaps/"
    ...
    _libs.$.fn.FlipBook = function(options) {
        ...
        return options = _extends({}, options), scene.view = new _BookView2.default(this.length ? this[0] : (0, _libs.$)("<div>").appendTo("body"), function() {
            _Detector2.default.webgl ? (scene.loadingCtrl = new _LoadingController2.default(scene.view, !0, function(progress) {
                return 0 === progress ? (0, _libs.tr)("Cargando visor..") : (0, _libs.tr)("Libro Cargado") + " " + progress + "%"
            ...
            return _inherits(Book, _THREE$EventDispatche), Book.prototype.dispose = function() {
                ...
                this.mouseController && ! function() {
                    var _data$data = data.data,
                        i = _data$data.i,
                        n = _data$data.n;
                    if ("mouseover9" === e.type) //comentado para evitar efecto esquinas hover
                        _this4.hoverInfo && void 0 !== _this4.hoverInfo.pendings ? ++_this4.hoverInfo.pendings : (_this4.hoverInfo && (console.warn("Wrong state: element is already hover"), _this4.hoverInfo.n !== n && _this4.clearHoverInfo()), _this4.hoverInfo || _this4.dragInfo || ! function() {
                ...
                this.animationNotification && (delete this.animationNotification,
                    this.layerManager.show(), this.dispatchEvent({
                        type: "afterAnimation"
                    }))
        ...
        BookView = function(_View) {
            ...
            return _inherits(BookView, _View), BookView.prototype.initView = function() {
                ...
                return {
                    ...
                    links: [{
                        rel: "stylesheet",
                        href: "app/fonts/fa/css/all.min.css"
                    }],
    ...
    var _libs = __webpack_require__(0),
        Bookmarks = function() {
            ...
            return Bookmarks.prototype.getSize = function() {
                ...
                return ['<div class="area">', node.children ? '<a href="#" class="cmd togle' + (node.minimized ? " minimized" : "") + '"><i class="fas fa-angle-right"></i></a> ' : '<i class="white-space"></i> ', '<a class="cmd" title="', node.title, '" href="#">', node.title, "</a></div>", node.minimized ? "" : this.renderNodes(node.children)].join("")
    ...
    var LoadingController = (__webpack_require__(0), function() {
        ...
        return LoadingController.defaultLoadingMsg = function(progress) {
            return ["Espere por favor, cargando visor...: ", progress, "%"].join("")
